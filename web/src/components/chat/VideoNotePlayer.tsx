...
export default function VideoNotePlayer(props: VideoNotePlayerProps) {
  ...
  return (
    ...
    >
      ...
      >
        <div class="bg-surface-raised p-4 rounded-full border border-border scale-90 group-hover:scale-100 transition-transform">
          {!isPlaying() ? (
      ...
      <div class="absolute top-10 left-1/2 -translate-x-1/2 pointer-events-none">
         <div 
          class="px-3 py-1 bg-surface-raised rounded-full border border-border text-[9px] font-mono font-bold text-text-primary tracking-widest uppercase opacity-0 group-hover:opacity-100 transition-all transform -translate-y-1 group-hover:translate-y-0"
